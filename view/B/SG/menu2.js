...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (!memberEmail) {
            ...
            document.getElementById("memberName").innerText = "Welcome " + welcomeText + "!";
        }
        var links = {
            tableDeskLink: "Tables & Desks",
            bedMattressLink: "Beds & Mattresses",
            sofaChairLink: "Sofas & Chair",
            cabinetStorageLink: "Cabinets & Storage",
            retailProductLink: "All Retail Products"
        };
        for (var id in links) {
            document.getElementById(id).setAttribute("href", "/B/" + countryPrefix + "/furnitureCategory.html?cat=" + encodeURIComponent(links[id]));
        }
    }, false);
